    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            function gearTouchEnd(e) {
                ...
                // console.log(target["new_" + target.id]+20);
        ...
        close: function(e) {
            e.preventDefault();
            var _self = this;
            var evt = new CustomEvent('input'); // 自定义事件对象
            _self.trigger.dispatchEvent(evt); // 触发自定义事件 
            var slideDown = document.querySelector(".area_ctrl");
            this.removeClass(slideDown,"slideInUp");
            this.addClass(slideDown,"slideInDown");
            slideDown.addEventListener("webkitAnimationEnd",function(){
